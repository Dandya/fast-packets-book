...
```
git clone https://gitflic.ru/project/dandya353/fast-packets-book.git
cd fast-packets-book
...
cd existing_folder
git init
git remote add origin https://gitflic.ru/project/dandya353/fast-packets-book.git
git clone
