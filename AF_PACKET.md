...
Если номер сетевого интерфейса, с которого ожидается захват пакетов, неизвестен, то получить его можно с помощью функции `if_nametoindex`, передав ей имя интерфейса.
