...
Система «AF_XDP» поддерживает два режима работы [1]:
...
Таким образом, большинство драйверов могут реализовать «zero-copy» режим передачи пакетов без необходимости вносить множество изменений в исходный код драйвера и реализовывать доступ из пространства пользователя.
...
```c
// contrib/linux-6.18/net/xdp/xsk_buff_pool.c
...
1. [Документация ядра «Linux» о «AF_XDP»](https://docs.kernel.org/networking/af_xdp.html)
2. [Magnus Karlsson and Bjorn T «The Path to DPDK Speeds for AF XDP»](http://oldvger.kernel.org/lpc_net2018_talks/lpc18_paper_af_xdp_perf-v2.pdf)
